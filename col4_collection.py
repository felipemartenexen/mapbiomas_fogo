...
assetIdFrom = 'projects/ee-felipe-martenexen/assets/fire_col4'
assetIdTo = f'projects/ee-geomapeamentoipam/assets/MAPBIOMAS_FOGO/COLECAO_4/Colecao4_fogo_v{version}'
biomes = ['AMAZONIA']
#'AMAZONIA', 'CAATINGA', 'CERRADO', 'MATA_ATLANTICA', 'PAMPA', 'PANTANAL'

satellite_years = [
    #{'satellite': 'l5', 'years': [1987,1988,1989,1990,1991,1992,1993,1994,1995,1996,1997,1998]},
            ...
            for year in years:
                ...
                try:
                    ...
                    if(not alreadyExists(name, currentImageCollection)):
                        ...
                        nameImage = f'queimada_{biome.lower()}_{satellite}_v{version}_region{region}_{year}'
